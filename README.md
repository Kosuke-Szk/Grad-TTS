...
## Notebook
```
docker build -t grad-tts -f Dockerfile .
```

```
docker run -v /home/ubuntu/workspace/Speech-Backbones/Grad-TTS:/opt/app --gpus all -p 8888:8888 -it --shm-size=2gb grad-tts
```
